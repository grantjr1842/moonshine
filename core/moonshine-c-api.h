...
/* Legacy integration paths that cannot complete an operation. Keep this
   distinct from MOONSHINE_ERROR_BUSY, which is part of the v0.1.5 TTS API. */
#define MOONSHINE_ERROR_NOT_IMPLEMENTED (-5)
